...
class Program:
    ...
    def step(self):
        ...
        print("step: get ts data:")
        print("input_1:", self.input_1)
        print("input_2:", self.input_2)

        # do some transformation
        self.input_1["output"][0]["fields"]["a"] = self.input_1["output"][0]["fields"]["a"] + self.input_2["output"][0]["fields"]["a"] + 2
        self.input_1["output"][1]["fields"]["a"] = self.input_1["output"][1]["fields"]["a"] + self.input_2["output"][1]["fields"]["a"] + 2

        print("input_1 (after transformation):", self.input_1)


        self.output = self.input_1["output"]
        self.get_data(1)
        self.notify(1)
